...
> 原文：[`tldp.org/LDP/abs/html/pathmanagement.html`](https://tldp.org/LDP/abs/html/pathmanagement.html)

埃马纽埃尔·鲁阿特（Emmanual Rouat）贡献了以下解析和转换*文件名*的示例，特别是路径名。它大量借鉴了*sed*的功能。
...
大卫·惠勒（David Wheeler）友好地允许我使用他的指导性示例。
