...
> 原文：[`tldp.org/LDP/abs/html/asciitable.html`](https://tldp.org/LDP/abs/html/asciitable.html)

传统上，这类书籍会有一个 ASCII 表附录。这本书没有。相反，这里提供了几个简短的脚本，每个脚本都能生成完整的 ASCII 表。

**示例 T-1. 生成 ASCII 表的脚本**
