...
> 原文：[School of SRE](https://linkedin.github.io/school-of-sre/)
> 
...
*   在我们的 [apachecn/linkedin-sre-tut-zh](https://github.com/apachecn/linkedin-sre-tut-zh) github 上提 issue.
...
```
docker pull apachecn0/linkedin-sre-tut-zh
docker run -tid -p <port>:80 apachecn0/linkedin-sre-tut-zh
...
```
pip install linkedin-sre-tut-zh
linkedin-sre-tut-zh <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g linkedin-sre-tut-zh
linkedin-sre-tut-zh <port>
# 访问 http://localhost:{port} 查看文档
```
