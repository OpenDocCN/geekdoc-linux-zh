...
When curl is built [debug enabled](ch306.xhtml#internals__tests__debug__md), it offers a special kind of testing. The tests we call **torture** tests. Do not worry, it is not quite as grim as it may sound.
...
This way of testing can take a seriously long time. I advise you to switch off [valgrind](ch311.xhtml#internals__tests__valgrind__md) when trying this out.
