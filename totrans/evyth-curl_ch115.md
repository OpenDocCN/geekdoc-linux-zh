...
curl provides a number of options to set the proxy type instead of using the scheme prefix. See the [SOCKS](ch116.xhtml#usingcurl__proxies__socks__md) section.