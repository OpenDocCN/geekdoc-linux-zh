...
The response body is passed to the [write callback](ch213.xhtml#transfers__callbacks__write__md) and the response headers to the [header callback](ch216.xhtml#transfers__callbacks__header__md).
