...
Send your contributions on a [mailing list](ch007.xhtml#project__comm__md), file an issue or submit a pull request.
...
The curl git tree can be browsed with a web browser on our GitHub page at [https://github.com/curl/curl](https://github.com/curl/curl).
