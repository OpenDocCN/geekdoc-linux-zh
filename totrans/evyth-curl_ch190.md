...
libcurl is a library of functions that are provided with a C API, for applications written in C. You can easily use it from C++ too, with only a few considerations (see [libcurl for C++ programmers](ch199.xhtml#libcurl__cplusplus__md)). For other languages, there exist *bindings* that work as intermediate layers between libcurl the library and corresponding functions for the particular language you like.
...
*   [Header files](ch190.xhtml#libcurl__headers__md)
*   [Global initialization](ch191.xhtml#libcurl__globalinit__md)
*   [API compatibility](ch192.xhtml#libcurl__api__md)
*   [–libcurl](ch193.xhtml#libcurl__--libcurl__md)
*   [multi-threading](ch194.xhtml#libcurl__threading__md)
*   [CURLcode return codes](ch195.xhtml#libcurl__curlcode__md)
*   [Verbose operations](ch196.xhtml#libcurl__verbose__md)
*   [Caches](ch197.xhtml#libcurl__caches__md)
*   [Performance](ch198.xhtml#libcurl__performance__md)
*   [for C++ programmers](ch199.xhtml#libcurl__cplusplus__md)