...
In most other ways, HTTPS proxies work like [HTTP proxies](ch115.xhtml#usingcurl__proxies__http__md).

## HTTP/2

When curl speaks with an HTTPS proxy, you have the option to use `--proxy-http2` to a ask curl to try using HTTP/2 with the proxy.
