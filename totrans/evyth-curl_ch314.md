...
All logs are parsed, managed and displayed on [the curl site](https://curl.se/dev/builds.html).

## Legacy

We started the autobuild system in 2003, a decade before [CI jobs](ch312.xhtml#internals__tests__ci__md) started becoming a serious alternative.
