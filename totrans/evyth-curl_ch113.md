...
Some network environments provides several different proxies that should be used in different situations, and a customizable way to handle that is supported by the browsers. This is called “[proxy auto-config](https://en.wikipedia.org/wiki/Proxy_auto-config)”, or PAC.
