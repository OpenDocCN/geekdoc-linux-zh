...
The **Expect** header is explained in the [Expect 100 continue](ch160.xhtml#http__post__expect100__md) chapter.
...
2.  Use the development tools in your favorite browser and inspect the POST request in the network tab after you have submitted it. Then convert that HTTP data to a curl command line. Unfortunately, the [copy as curl](ch077.xhtml#cmdline__copyas__md) feature in the browsers usually do not actually do multipart formposts particularly well.
