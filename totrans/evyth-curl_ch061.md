...
The query part of a URL is the data that is to the right of a question mark (`?`) but to the left of the [fragment](ch062.xhtml#cmdline__urls__fragment__md), which begins with a hash (`#`).
