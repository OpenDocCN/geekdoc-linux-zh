...
You can usually work around that by just reading the JavaScript code and redoing that logic in your script. Using the tricks in [Figure out what a browser sends](ch163.xhtml#http__post__browsersends__md) to check exactly what a browser sends is then also a good help.