...
If you want to make a test that does not invoke the curl command line tool, then you should consider the [libcurl tests](ch309.xhtml#internals__tests__libcurl__md) or [unit tests](ch310.xhtml#internals__tests__unit__md) instead.