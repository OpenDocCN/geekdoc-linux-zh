...
A user can use the [–write-out](ch081.xhtml#usingcurl__verbose__writeout__md) option’s `%filename_effective` variable to figure out which name that was eventually used.
