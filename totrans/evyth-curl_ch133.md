...
Showing the curl version information with [curl –version](ch074.xhtml#cmdline__curlver__md) includes the TLS library and version in the first line of output.
